...
if(isset($_POST['nama_pelanggan'])){
    ...
    $query = mysqli_query($koneksi, "UPDATE pelanggan set nama_pelanggan='$nama', alamat='$alamat', nomor_telepon='$no_telepon' WHERE pelanggan_id=$id");
    if($query){
                        ...
                        <form method="post">
                            <table class= "table table-bordered">
                                ...
                                <tr>
                                    <td>No telepon</td>
                                    <td>:</td>
                                    <td><input class="form-control" type="number" step="0" value="<?php echo $data['nomor_telepon']; ?>" name="nomor_telepon"></td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td></td>
